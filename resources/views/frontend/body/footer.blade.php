...
<footer class="main">
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            ...
                            <a href="/" class="mb-15"><img src="{{ asset($setting->logo ) }}" alt="logo" /></a>
                                <p class="font-lg text-heading">Awesome E-Waste Shop Website </p>
                            </div>
    ...
    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-clock.svg') }}" alt="" /><strong>Hours: </strong><span> 8:00 - 18:00, Mon - Sat</span></li>
</ul>
                        </div>
                    </div>
