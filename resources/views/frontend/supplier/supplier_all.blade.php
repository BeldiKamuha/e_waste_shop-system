...
<div class="page-header breadcrumb-wrap">
        ...
        <div class="page-content pt-50">
            <div class="container">
                <div class="archive-header-2 text-center">
                    <h1 class="display-2 mb-50">Suppliers List</h1>
                    <div class="row">
                    ...
                    <div class="col-12 col-lg-8 mx-auto">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p>We have <strong class="text-brand">{{ count($suppliers) }}</strong> suppliers now</p>
                            </div>
  ...
  <a href="{{ route('supplier.details',$supplier->id) }}">
   ...
   <span class="font-small total-product">{{ count($products) }} products</span>
                                ...
                                <div class="vendor-info mb-30">
                                    <ul class="contact-infor text-muted">
                                        <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>{{ $supplier->address }}</span></li>
                                        <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us:</strong><span>{{ $supplier->phone }}</span></li>
                                    </ul>
                                </div>
