...
@php
	...
	$supplier = App\Models\User::where('status','active')->where('role','supplier')->get();
	$customer = App\Models\User::where('status','active')->where('role','customer')->get();
@endphp
					 ...
					 <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
							...
							<div class="card radius-10 bg-gradient-deepblue">
							 <div class="card-body">
								...
								<h5 class="mb-0 text-white">Ksh {{ $today }}</h5>
									<div class="ms-auto">
                                        <i class='bx bx-ksh fs-3 text-white'></i>
									</div>
								</div>
						...
						<div class="col">
							<div class="card radius-10 bg-gradient-ibiza">
							 <div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{ count($supplier) }}</h5>
									<div class="ms-auto">
