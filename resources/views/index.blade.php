...
<div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
    <div class="card">
        <div class="card-header">
            ...
            <br>
              <img id="showImage" src="{{ (!empty($customerData->photo)) ? url('upload/customer_images/'.$customerData->photo):url('upload/no_image.jpg') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
...
<div class="row">
    <div class="form-group col-md-6">
        ...
        <input required="" class="form-control" name="username" type="text" value="{{ $customerData->username }}" />
    </div>
    <div class="form-group col-md-6">
        <label>Full Name <span class="required">*</span></label>
        <input required="" class="form-control" name="name" value="{{ $customerData->name }}" />
    </div>
    <div class="form-group col-md-12">
        <label>Email <span class="required">*</span></label>
        <input required="" class="form-control" name="email" type="text" value="{{ $customerData->email }}" />
    </div>
    <div class="form-group col-md-12">
        <label>Phone <span class="required">*</span></label>
        <input required="" class="form-control" name="phone" type="text" value="{{ $customerData->phone }}" />
    </div>
    <div class="form-group col-md-12">
    ...
    <div class="form-group col-md-12">
      ...
      <div class="form-group col-md-12">
        ...
        <img id="showImage" src="{{ (!empty($customerData->photo)) ? url('upload/customer_images/'.$customerData->photo):url('upload/no_image.jpg') }}" alt="Customer" class="rounded-circle p-1 bg-primary" width="110">
    </div>
