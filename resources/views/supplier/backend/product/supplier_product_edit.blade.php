...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edit Supplier Product</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Edit Supplier Product</li>
							</ol>
						</nav>
					</div>
...
<div class="card">
  <div class="card-body p-4">
	  <h5 class="card-title">Edit Supplier Product</h5>
	  <hr/>

<form id="myForm" method="post" action="{{ route('supplier.update.product') }}"  >
			@csrf
 	...
 	<option value="{{ $products->brand }}" {{ $products->brand == $products->brand ? 'selected' : '' }} >{{ $products->brand }}</option>
     ...
     <option value="Hp">Hp</option>
				  ...
				  <div class="form-group col-12">
					...
					<select name="category" class="form-select" id="inputSupplier">
						<option></option>
                        
						
						<option value="{{ $products->category }}" {{ $products->category == $products->category ? 'selected' : '' }}>{{ $products->category }}</option>
...
<div class="page-content">
	...
	<hr>
<div class="card">
<form method="post" action="{{ route('supplier.update.product.thambnail') }}" enctype="multipart/form-data" >
			@csrf
...
<div class="card-body">
 ...
 <form method="post" action="{{ route('supplier.update.product.multiimage') }}" enctype="multipart/form-data" >
			@csrf
	...
	<a href="{{ route('supplier.product.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete" > Delete </a>		
		</td>
	</tr>
	@endforeach		 
